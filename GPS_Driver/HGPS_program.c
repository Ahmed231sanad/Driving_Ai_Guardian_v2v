...
enumPrivFrameCheck(*ptr)(void)=HGPS_voidFrameFandling; // ptr to func which is must be called after uart reception is finished
void GPS_init(void)
{
    UART_init () ;
}
...
enumPrivFrameCheck HGPS_voidFrameFandling(void)
{
